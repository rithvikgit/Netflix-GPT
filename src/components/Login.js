...
import { LOGIN_BACKGROUNG, USER_AVATAR } from "../utils/constants";
  ...
  return (
    <div>
      ...
      <form
        ...
        className="w-5/6 md:w-3/12 p-12 bg-black absolute my-36 mx-auto right-0 left-0 text-white bg-opacity-90"
      >
